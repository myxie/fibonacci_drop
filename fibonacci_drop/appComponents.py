"""
fibonacci_drop appComponent module.

This is the module of fibonacci_drop containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/fibonacci_drop.MyApp/String/readonly/
