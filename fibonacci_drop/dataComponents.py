"""
fibonacci_drop component module.

This is the module of fibonacci_drop containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/fibonacci_drop.MyData/String/readonly/
