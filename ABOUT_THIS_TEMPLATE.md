...
├── fibonacci_drop             # The main python package for the project
...
Just click on [Use this template](https://github.com/ICRAR/daliuge-component-template/generate) and you are good to go.
...
e.g: `cat fibonacci_drop/VERSION` will get the project version without harming
