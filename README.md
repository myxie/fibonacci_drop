...
- 🎯 Entry points to execute your program using `python -m <fibonacci_drop>` or `$ fibonacci_drop` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/myxie/fibonacci_drop/branch/main/graph/badge.svg?token=fibonacci_drop_token_here)](https://codecov.io/gh/myxie/fibonacci_drop)
[![CI](https://github.com/myxie/fibonacci_drop/actions/workflows/main.yml/badge.svg)](https://github.com/myxie/fibonacci_drop/actions/workflows/main.yml)
